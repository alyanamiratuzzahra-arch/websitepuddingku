...
<body>
    <section class="hero-slider" id="home">
        ...
        <div class="slide">
            <img id="heroImage3" src="img/bg/.png" alt="Pudding">
        </div>
        <div class="slide">
...
<section id="menu" class="py-5" style="background: linear-gradient(135deg, #FFF0F5 0%, #FFE5EC 50%, #FFC9D9 100%); margin: 0; width: 100%;">
  <div class="container-fluid px-5">
    ...
    <!-- Header Menu -->
<div class="text-center mb-5" data-aos="fade-up">
  <h2 class="display-4 fw-bold mb-2" style="color: #d97706; font-size: 2.5rem;">Our Menu</h2>
  <p class="text-muted" style="font-size: 1.1rem;">Pilihan Lezat untuk Setiap Selera 🍰</p>
</div>

    <!-- Filter Tabs dengan Design Modern -->
<ul class="nav nav-pills justify-content-center mb-5" id="menuTabs" data-aos="fade-up" data-aos-delay="100">
  <li class="nav-item">
  ...
  <li class="nav-item">
    ...
    <div class="row g-4" id="menuList">
      ...
      <!-- Best Seller 1 -->
<div class="col-md-3 col-sm-6" data-category="best seller">
  <div class="card h-100 shadow-sm position-relative">
    ...
    <div class="card-body text-center">
      ...
      <div class="col-md-3 col-sm-6" data-category="pudding">
        <div class="card h-100 shadow-sm">
          <img src="img/pudding/silky pudding_mango.jpg" class="card-img-button" alt="Pudding">
          <div class="card-body text-center">
      ...
      <div class="col-md-3 col-sm-6" data-category="pudding">
        <div class="card h-100 shadow-sm">
          ...
          <div class="card-body text-center">
            ...
            <p class="card-text">Pudding lembut dengan rasa bubble gum manis unik yang membawa nuansa ceria.</p>
            <div class="divider"></div>
            <p class="fw-bold text-primary">Rp4.000</p>
          </div>
        </div>
